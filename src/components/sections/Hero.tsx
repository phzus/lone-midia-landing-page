...
export function Hero() {
  return (
    ...
    >
      {/* Imagem composta (fundadores + glow + gráfico) */}
      <Image
      ...
      <Container className="relative z-10 flex flex-1 flex-col justify-center pt-16 pb-10 sm:pt-20">
        <Reveal className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink-soft">
            ...
            <strong className="font-semibold text-ink">Lone Growth</strong> pra
            parar de gastar com anúncio que não vende. Tráfego pago segmentado +
            comercial organizado, operando como uma engrenagem só.
          </p>
